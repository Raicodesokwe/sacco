...
import 'package:saccoapp/pages/loanterms/fourthloan/weeklyfeedeets.dart';



class FourthWeekly extends StatelessWidget {
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => WeeklyFeeDeets()));
              },
              child: Container(
                width: size.width * 0.8,
                child: Row(
