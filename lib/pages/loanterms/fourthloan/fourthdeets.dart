...
import 'package:saccoapp/pages/loanterms/fourthloan/fourthfee.dart';

class FourthDeets extends StatelessWidget {
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => FourthFeeDeets()));
              },
              child: Container(
                width: size.width * 0.8,
                child: Row(
