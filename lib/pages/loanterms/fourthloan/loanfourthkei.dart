...
import 'package:saccoapp/pages/loanterms/fourthloan/anodacase.dart';
import 'package:saccoapp/pages/loanterms/fourthloan/fourthdeets.dart';
import 'package:saccoapp/pages/loanterms/fourthloan/fourthmonthly.dart';
import 'package:saccoapp/pages/loanterms/fourthloan/fourthweekly.dart';

import 'package:saccoapp/pages/loanterms/fourthloan/loanfourthprocessor.dart';
import 'package:saccoapp/pages/loanterms/fourthloan/optiontatu.dart';



enum InterestTerms { firstoption, secondOption, thirdOption }

class FourthKei extends StatefulWidget {
  @override
  State<FourthKei> createState() => _FourthKeiState();
}

class _FourthKeiState extends State<FourthKei> {
 ...
 final _tutsi = new GlobalKey<FormState>();

  checkFields() {
    final form = _tutsi.currentState;
    if (form!.validate()) {
      form.save();
      return true;
    }
              ...
              child: Column(
                children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(r'ksh' + " ${numberFormat.format(250)}",
                        ...
                        child: AbsorbPointer(
                          child: TextFormField(
                            controller: _interestfirstcontroller,
                               validator: (value) =>
                          value!.isEmpty ? 'Loan terms are required' : null,
                        ...
                        Flexible(
                            child: AbsorbPointer(
                              child: TextFormField(
                                  ...
                                  decoration:
                                      InputDecoration(labelStyle: GoogleFonts.prompt(),border: InputBorder.none)),
                            ))
                      ],
                    ),
                  ),
                  ...
                  GestureDetector(
                    onTap: () {
                      if(checkFields())
                          if (_interestfirstcontroller.text ==
                          '28 days\n 1 monthly payment of KSH294'){
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => LoanFourthProcessor()));
                          }else if(_interestfirstcontroller.text ==
                          '28 days\n 4 weekly payments of KSH74'){
                             Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => AnodaCase()));
                          } else {
                             Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => OptionTatu()));
                          }
                    },
                    child: Container(
                      height: 50.0,
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      if (_interestfirstcontroller.text ==
                          '28 days\n 1 monthly payment of KSH294') {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => FourthDeets()));
                      } else if (_interestfirstcontroller.text ==
                          '28 days\n 4 weekly payments of KSH74') {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => FourthWeekly()));
                      }else if (_interestfirstcontroller.text ==
                          '62 days\n 2 monthly payments of KSH169'){
                         Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => FourthPonMonth()));
                      }
                    },
                    child: Container(
                      width: size.width * 0.8,
          ...
          RadioListTile<InterestTerms>(
            ...
            onChanged: (InterestTerms? value) {
              setModalState(() {
                ...
                _twocontroller.text = 'Ksh 44';
                _threecontroller.text= 'Total due';
                _fourcontroller.text='Ksh294';
              });
            },
          ),
          RadioListTile<InterestTerms>(
            ...
            onChanged: (InterestTerms? value) {
              setModalState(() {
                ...
                _interestfirstcontroller.text =
                    '28 days\n 4 weekly payments of KSH74';
                _onecontroller.text = 'Interest';
                _twocontroller.text = 'Ksh 46';
                _threecontroller.text= 'Total due';
                _fourcontroller.text='Ksh296';
              });
            },
          ),
          RadioListTile<InterestTerms>(
