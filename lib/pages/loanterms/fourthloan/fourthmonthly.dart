...
import 'package:saccoapp/pages/loanterms/fourthloan/fourmonfeedeets.dart';

class FourthPonMonth extends StatelessWidget {
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => FourMonFeeDeets()));
              },
              child: Container(
                width: size.width * 0.8,
                child: Row(
