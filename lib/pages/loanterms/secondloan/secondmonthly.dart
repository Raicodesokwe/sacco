...
import 'package:saccoapp/pages/loanterms/secondloan/secondmonfeedeets.dart';

class SecondMonthly extends StatelessWidget {
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => SecondMonFeeDeets()));
              },
              child: Container(
                width: size.width * 0.8,
                child: Row(
