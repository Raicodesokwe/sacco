...
import 'package:saccoapp/pages/loanterms/secondloan/loanfirstdetail.dart';
import 'package:saccoapp/pages/loanterms/secondloan/loansegundaprocessor.dart';
import 'package:saccoapp/pages/loanterms/secondloan/secondmonthly.dart';
import 'package:saccoapp/pages/loanterms/secondloan/secondweekly.dart';
import 'package:saccoapp/pages/loanterms/secondloan/uberalles.dart';

enum InterestTerms { firstoption, secondOption, thirdOption }

class TwoKei extends StatefulWidget {
  @override
  State<TwoKei> createState() => _TwoKeiState();
}

class _TwoKeiState extends State<TwoKei> {
  ...
  final _hitu = new GlobalKey<FormState>();

  checkFields() {
    final form = _hitu.currentState;
    if (form!.validate()) {
      form.save();
      return true;
    }
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(r'ksh' + " ${numberFormat.format(1000)}",
                  ...
                  GestureDetector(
                    onTap: () {
                      if (checkFields()) if (_interestfirstcontroller.text ==
                              '28 days\n 1 monthly payment of KSH1,176' ||
                          _interestfirstcontroller.text ==
                              '28 days\n 4 weekly payments of KSH294') {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => LoanSegunda()));
                      }else {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => UberAlles()));
                      }
                    },
                    child: Container(
                      height: 50.0,
                  ...
                  GestureDetector(
                    onTap: () {
                      if (checkFields()) if (_interestfirstcontroller.text ==
                          '28 days\n 1 monthly payment of KSH1,176') {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => LoanFirstDetail()));
                      } else if (_interestfirstcontroller.text ==
                          '28 days\n 4 weekly payments of KSH294') {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => SecondWeekly()));
                      } else if (_interestfirstcontroller.text ==
                          '62 days\n 2 monthly payments of KSH676') {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => SecondMonthly()));
                      }
                    },
                    child: Container(
                      width: size.width * 0.8,
