...
import 'package:saccoapp/pages/loanterms/thirdloan/thirdmonfeedetails.dart';

class ThirdMonthly extends StatelessWidget {
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => ThirdMonFeeDeets()));
              },
              child: Container(
                width: size.width * 0.8,
                child: Row(
