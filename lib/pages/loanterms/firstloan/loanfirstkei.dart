...
import 'package:saccoapp/pages/loanterms/firstloan/loanmonthly.dart';
import 'package:saccoapp/pages/loanterms/firstloan/loanthirdoption.dart';
import 'package:saccoapp/pages/loanterms/firstloan/loanweeklydeets.dart';

import 'package:saccoapp/pages/loanterms/firstloan/loandeets.dart';
import 'package:saccoapp/pages/loanterms/firstloan/loanprocessing.dart';


enum InterestTerms { firstoption, secondOption, thirdOption }

class FirstKei extends StatefulWidget {
  @override
  State<FirstKei> createState() => _FirstKeiState();
}

class _FirstKeiState extends State<FirstKei> {
 ...
 final _sare = new GlobalKey<FormState>();

  checkFields() {
    final form = _sare.currentState;
    if (form!.validate()) {
      form.save();
      return true;
    }
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(r'ksh' + " ${numberFormat.format(2000)}",
                  ...
                  GestureDetector(
                    onTap: () {
                     ...
                     if (_interestfirstcontroller.text ==
                          '28 days\n 1 monthly payment of KSH2,352' || _interestfirstcontroller.text ==
                          '28 days\n 4 weekly payments of KSH588'){
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => LoanProcessing()));
                          }else {
                             Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => LoanThirdOption()));
                          }
                    },
                    child: Container(
                      height: 50.0,
                  ...
                  SizedBox(
                   ...
                   GestureDetector(
                    onTap: () {
                      ...
                      if (_interestfirstcontroller.text ==
                          '28 days\n 1 monthly payment of KSH2,352') {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => LoanDeets()));
                      } else if (_interestfirstcontroller.text ==
                          '28 days\n 4 weekly payments of KSH588') {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => LoanWeeklyDeets()));
                      } else if (_interestfirstcontroller.text ==
                          '62 days\n 2 monthly payments of KSH1,352') {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => LoanMonthly()));
                      }
                    },
                    child: Container(
                            width: size.width * 0.8,
          ...
          RadioListTile<InterestTerms>(
            ...
            onChanged: (InterestTerms? value) {
              setModalState(() {
                ...
                _twocontroller.text = 'Ksh 352';
                _threecontroller.text = 'Total due';
                _fourcontroller.text = 'Ksh2,352';
            ...
            onChanged: (InterestTerms? value) {
              setModalState(() {
                ...
                _interestfirstcontroller.text =
                    '62 days\n 2 monthly payments of KSH1,352';
                _onecontroller.text = 'Interest';
                _twocontroller.text = 'Ksh 704';
                _threecontroller.text = 'Total due';
                _fourcontroller.text = 'Ksh2,704';
              });
            },
          ),
        ],
