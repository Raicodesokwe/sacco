...
import 'package:saccoapp/pages/loanterms/firstloan/loanmonthlyfeedeets.dart';

class LoanMonthly extends StatelessWidget {
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => LoanMonthlyFeeDeets()));
              },
              child: Container(
                width: size.width * 0.8,
                child: Row(
